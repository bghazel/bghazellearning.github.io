...
$appname = "WingetInstall"

Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bghazel/bghazellearning.github.io/refs/heads/main/PowerShell/Toolbox/$appname.ps1" -OutFile "C:\Toolbox\$appname.ps1"