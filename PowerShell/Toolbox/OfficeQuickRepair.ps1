Start-Transcript -Path "C:\Toolbox\Logs\OfficeQuickRepair.log" -Append
...
if ($officeExe) {
    ...
    # Run Quick Repair
    Start-Process $officeExe -ArgumentList "scenario=repair platform=x64 culture=en-us forceappshutdown=true RepairType=QuickRepair DisplayLevel=true" -Wait
